...
def set_background(image_file):
    try:
        ...
        st.error(f"Error: No se encontró la imagen en {image_file}. Verifica la ruta.")
...
if not partidos_data:
    ...
    # --- PASO 3: PRESENTACIÓN DEL RESULTADO ---
    st.markdown("---")
